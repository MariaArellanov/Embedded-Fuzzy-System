...
from DHT11 import *
from ClockBuzzer import *
#New libraries for Raspberry Pi
import RPi.GPIO as GPIO# Library for using the Raspberry Pi's GPIO ports
import time
...
dht11 = DHT11()
temp = dht11.lecture()
in_values_health = {"med": 0.91,"press": 0.102,"b_temp": temp/50}
...
if wellbeing.color()=="Blue":
   GPIO.output(7, True)
   time.sleep(1)
   GPIO.output(7, False)
GPIO.cleanup()
print("Wellbeing result:",wellbeing.color(),"LED TURN ON")
print("Wellbeing finishes")
print("")
...
GPIO.cleanup()
print("Health result: ",health.color(),"LED TURN ON")
print("Health finishes")
print("")
